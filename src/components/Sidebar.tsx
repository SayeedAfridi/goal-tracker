...
import { closeSidebar } from '@src/lib/utils';
...
export const Sidebar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <AppLogo />
        <Typography level='title-lg'>Goal Tracker</Typography>
      ...
      >
        ...
        >
          <ListItem component={Link} to={ROUTE_NAMES.DASHBOARD}>
            <ListItemButton
              selected={location.pathname === ROUTE_NAMES.DASHBOARD}
            >
